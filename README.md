...
operator queue korzysta z chronionego `/dashboard/events/:eventId/stream`. Oba widoki zachowuja reczny oraz
jednorazowy focus/visibility refresh, ale nie uruchamiaja cyklicznego pollingu.
